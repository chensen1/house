<template>
  <div>
    ...
    <div class="listTab">
      ...
      <p class="title" style="margin-top:80px"><span class="lingxing"></span>卖家纳税</p>
      ...
      <div class="tableBox tableBg">
        <table style="width:100%" cellpadding="0" border="0" cellspacing="0">
          ...
          <tr>
            ...
            <td align="right">{{houseInfo.price *10000}}</td>
          </tr>
          <tr>
      ...
      <p class="second-tit">三、出卖人信息</p>
      <div class="tableBox tableBg">
        <table style="width:100%" cellpadding="0" border="0" cellspacing="0">
          <tr>
            <td align="left"  class="leftTit">出卖人：</td>
      ...
      <p class="second-tit" style="color:red">四、出卖人税款信息</p>
      <div class="tableBox tableBg">
        <table style="width:100%" cellpadding="0" border="0" cellspacing="0">
          <tr>
      ...
      <p style="margin-top:50px;text-align:center">
        <el-button type="info" v-if="houseInfo.status < 9"> 待买家纳税</el-button>
        <el-button type="info" v-else-if="houseInfo.status < 10"> 待买家申请产权证</el-button>
        <el-button type="primary" @click="toNextPage" v-else> 进入下一步</el-button>
      </p>
    </div>
...
export default {
  ...
  methods: {
    ...
    toPay () {
      updataHouseStatue({ hid: this.houseId, uid: this.hangOutUser.uid, status: 8 }).then(res => {
        this.getHouseInfo()
      })
        .catch(error => {
          console.log(error)
